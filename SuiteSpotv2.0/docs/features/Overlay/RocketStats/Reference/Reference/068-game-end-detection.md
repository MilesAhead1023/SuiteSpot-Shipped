# Implementation Spec: Detect and track match end

**Capability ID**: 68 | **Slug**: game-end-detection

## Overview

This capability hooks into Rocket League game events to detect detect and track match end. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:435 (HookEvent OnMatchWinnerSet), GameManagement.cpp:48 (GameEnd)
