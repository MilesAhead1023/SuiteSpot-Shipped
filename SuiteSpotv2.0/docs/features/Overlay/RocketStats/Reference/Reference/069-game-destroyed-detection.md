# Implementation Spec: Detect mid-match quit or crash

**Capability ID**: 69 | **Slug**: game-destroyed-detection

## Overview

This capability hooks into Rocket League game events to detect detect mid-match quit or crash. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:436 (HookEvent GameEvent_TA.Destroyed), GameManagement.cpp:128 (GameDestroyed)
