# Implementation Spec: Track individual match statistics

**Capability ID**: 70 | **Slug**: stat-event-tracking

## Overview

This capability hooks into Rocket League game events to detect track individual match statistics. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:449 (HookEventWithCallerPost HandleStatEvent), StatsManagement.cpp:23 (onStatEvent)
