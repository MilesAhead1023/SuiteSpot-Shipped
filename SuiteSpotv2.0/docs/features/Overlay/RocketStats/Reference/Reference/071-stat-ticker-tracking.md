# Implementation Spec: Track accolade achievements

**Capability ID**: 71 | **Slug**: stat-ticker-tracking

## Overview

This capability hooks into Rocket League game events to detect track accolade achievements. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:450 (HookEventWithCallerPost HandleStatTickerMessage), StatsManagement.cpp:533 (onStatTickerMessage)
