# Implementation Spec: Detect goal score events

**Capability ID**: 72 | **Slug**: goal-score-detection

## Overview

This capability hooks into Rocket League game events to detect detect goal score events. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:440 (HookEvent TriggerGoalScoreEvent), StatsManagement.cpp (onGoalScore)
