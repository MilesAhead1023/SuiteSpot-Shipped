# Implementation Spec: Track boost activation

**Capability ID**: 73 | **Slug**: boost-activation-tracking

## Overview

This capability hooks into Rocket League game events to detect track boost activation. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:437 (HookEvent OnBoostAmountChanged.BeginState), BoostManagement.cpp:3 (OnBoostStart)
