# Implementation Spec: Track boost amount changes

**Capability ID**: 74 | **Slug**: boost-amount-tracking

## Overview

This capability hooks into Rocket League game events to detect track boost amount changes. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:438 (HookEvent EventBoostAmountChanged), BoostManagement.cpp:25 (OnBoostChanged)
