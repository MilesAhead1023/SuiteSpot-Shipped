# Implementation Spec: Track boost depletion

**Capability ID**: 75 | **Slug**: boost-end-tracking

## Overview

This capability hooks into Rocket League game events to detect track boost depletion. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:439 (HookEvent CarComponent_Boost_TA.Active.EndState), BoostManagement.cpp:48 (OnBoostEnd)
