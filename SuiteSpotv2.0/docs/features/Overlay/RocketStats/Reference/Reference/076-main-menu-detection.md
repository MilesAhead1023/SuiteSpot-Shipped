# Implementation Spec: Track main menu entry

**Capability ID**: 76 | **Slug**: main-menu-detection

## Overview

This capability hooks into Rocket League game events to detect track main menu entry. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:441 (HookEvent OnEnteredMainMenu)
