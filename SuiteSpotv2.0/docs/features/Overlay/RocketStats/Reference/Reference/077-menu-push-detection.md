# Implementation Spec: Track menu stack push

**Capability ID**: 77 | **Slug**: menu-push-detection

## Overview

This capability hooks into Rocket League game events to detect track menu stack push. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:442 (HookEvent GFxData_MenuStack_TA.PushMenu)
