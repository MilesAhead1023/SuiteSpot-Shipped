# Implementation Spec: Track scoreboard opening

**Capability ID**: 79 | **Slug**: scoreboard-open-detection

## Overview

This capability hooks into Rocket League game events to detect track scoreboard opening. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:446 (HookEvent OnOpenScoreboard)
