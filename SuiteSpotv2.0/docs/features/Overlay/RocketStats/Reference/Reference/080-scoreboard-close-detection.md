# Implementation Spec: Track scoreboard closing

**Capability ID**: 80 | **Slug**: scoreboard-close-detection

## Overview

This capability hooks into Rocket League game events to detect track scoreboard closing. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:447 (HookEvent OnCloseScoreboard)
