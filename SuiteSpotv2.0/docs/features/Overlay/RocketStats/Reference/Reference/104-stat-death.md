# Implementation Spec: Track death counter

**Capability ID**: 104 | **Slug**: stat-death

## Overview

This capability tracks track death counter in Rocket League matches. The statistic is accumulated across four aggregation levels (session, per-playlist, all-time, all-time per-gamemode) and synchronized with file output and WebSocket streams.
...
- **Evidence**: StatsManagement.cpp (onStatEvent), Vars/Miscs.cpp::VarMiscsDeath
