# Implementation Spec: Update player MMR

**Capability ID**: 113 | **Slug**: mmr-update

## Overview

This capability hooks into Rocket League game events to detect update player mmr. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: StatsManagement.cpp::UpdateMMR (updates myMMR, MMRChange, MMRCumulChange)
