# Implementation Spec: Broadcast game state to WebSocket clients

**Capability ID**: 141 | **Slug**: websocket-broadcast-game-state

## Overview

This capability manages WebSocket communication for broadcast game state to websocket clients. Messages are broadcast to OBS clients on port 8085 in JSON format.
...
- **Evidence**: SocketManagement.cpp::SocketBroadcast, GameManagement.cpp::SendGameState
