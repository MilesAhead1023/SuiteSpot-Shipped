# Implementation Spec: Send game start notification via WebSocket

**Capability ID**: 142 | **Slug**: websocket-game-start-notification

## Overview

This capability manages WebSocket communication for send game start notification via websocket. Messages are broadcast to OBS clients on port 8085 in JSON format.
...
- **Evidence**: GameManagement.cpp (SocketSend 'GameStart' message)
