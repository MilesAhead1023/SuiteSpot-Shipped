# Implementation Spec: Send game win notification via WebSocket

**Capability ID**: 143 | **Slug**: websocket-game-won-notification

## Overview

This capability manages WebSocket communication for send game win notification via websocket. Messages are broadcast to OBS clients on port 8085 in JSON format.
...
- **Evidence**: GameManagement.cpp::GameEnd (SocketSend 'GameWon')
