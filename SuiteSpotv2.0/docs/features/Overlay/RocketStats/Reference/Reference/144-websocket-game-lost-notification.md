# Implementation Spec: Send game loss notification via WebSocket

**Capability ID**: 144 | **Slug**: websocket-game-lost-notification

## Overview

This capability manages WebSocket communication for send game loss notification via websocket. Messages are broadcast to OBS clients on port 8085 in JSON format.
...
- **Evidence**: GameManagement.cpp::GameEnd (SocketSend 'GameLost')
