# Implementation Spec: Include game context state in WebSocket messages

**Capability ID**: 149 | **Slug**: websocket-game-context

## Overview

This capability manages WebSocket communication for include game context state in websocket messages. Messages are broadcast to OBS clients on port 8085 in JSON format.
...
- **Evidence**: SocketManagement.cpp::SocketData (includes IsInGame, IsInMenu, IsInFreeplay, IsInScoreboard, IsOnlineGame, IsOfflineGame)
