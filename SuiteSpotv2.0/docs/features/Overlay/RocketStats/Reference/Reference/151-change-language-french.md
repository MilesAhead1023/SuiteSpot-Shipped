# Implementation Spec: Change plugin language to French (FRA)

**Capability ID**: 151 | **Slug**: change-language-french
...
- **Evidence**: LangManagement.cpp::ChangeLang (IDB_LANG_FRA), RocketStats.cpp:342
