# Implementation Spec: Extract embedded title image resource

**Capability ID**: 153 | **Slug**: extract-title-resource

## Overview

This capability provides extract embedded title image resource functionality for the RocketStats plugin. It integrates with the BakkesMod SDK and interacts with other subsystems through configuration variables, game events, or UI elements.

## Control Surfaces

- **Type**: `resource`
- **Evidence**: RocketStats.cpp:394-398 (WriteResInFile with IDB_TITLE resource)
