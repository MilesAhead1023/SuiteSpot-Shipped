# Implementation Spec: Register custom URL protocol handler

**Capability ID**: 155 | **Slug**: register-custom-protocol

## Overview

This capability provides register custom url protocol handler functionality for the RocketStats plugin. It integrates with the BakkesMod SDK and interacts with other subsystems through configuration variables, game events, or UI elements.

## Control Surfaces

- **Type**: `windows`
- **Evidence**: RocketStats.cpp::SetCustomProtocol (registers RocketStats:// protocol in registry)
