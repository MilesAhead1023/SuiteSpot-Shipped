# Implementation Spec: Detect main menu UI language

**Capability ID**: 157 | **Slug**: detect-ui-language

## Overview

This capability hooks into Rocket League game events to detect detect main menu ui language. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:341 (gameWrapper->GetUILanguage())
