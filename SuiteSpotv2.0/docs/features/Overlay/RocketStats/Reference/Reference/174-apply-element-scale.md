# Implementation Spec: Apply theme element scale factor

**Capability ID**: 174 | **Slug**: apply-element-scale

## Overview

This capability provides apply theme element scale factor functionality for the RocketStats plugin. It integrates with the BakkesMod SDK and interacts with other subsystems through configuration variables, game events, or UI elements.

## Control Surfaces

- **Type**: `ui`
- **Evidence**: RocketStats.h (Element.scale field), OverlayManagement.cpp::RenderElement
