# Implementation Spec: Apply theme text alignment

**Capability ID**: 175 | **Slug**: apply-text-alignment

## Overview

This capability provides apply theme text alignment functionality for the RocketStats plugin. It integrates with the BakkesMod SDK and interacts with other subsystems through configuration variables, game events, or UI elements.

## Control Surfaces

- **Type**: `ui`
- **Evidence**: Default/config.json (align: left/center/right)
