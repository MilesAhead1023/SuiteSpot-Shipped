# Implementation Spec: Display opponent score in match

**Capability ID**: 178 | **Slug**: display-opponent-score

## Overview

This capability tracks display opponent score in match in Rocket League matches. The statistic is accumulated across four aggregation levels (session, per-playlist, all-time, all-time per-gamemode) and synchronized with file output and WebSocket streams.
...
- **Evidence**: Vars/Other.cpp::VarScoreOpposite
