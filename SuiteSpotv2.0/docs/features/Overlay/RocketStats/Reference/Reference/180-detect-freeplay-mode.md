# Implementation Spec: Detect freeplay mode

**Capability ID**: 180 | **Slug**: detect-freeplay-mode

## Overview

This capability hooks into Rocket League game events to detect detect freeplay mode. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:439, RocketStats.h (is_in_freeplay flag)
