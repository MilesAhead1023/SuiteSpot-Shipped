# Implementation Spec: Detect offline game mode

**Capability ID**: 181 | **Slug**: detect-offline-game

## Overview

This capability hooks into Rocket League game events to detect detect offline game mode. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.h (is_offline_game flag), SocketManagement.cpp
