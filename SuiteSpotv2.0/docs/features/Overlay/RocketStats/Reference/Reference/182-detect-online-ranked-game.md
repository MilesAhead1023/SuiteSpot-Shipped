# Implementation Spec: Detect online ranked game

**Capability ID**: 182 | **Slug**: detect-online-ranked-game

## Overview

This capability hooks into Rocket League game events to detect detect online ranked game. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.h (is_online_game, current.ranked flags)
