# Implementation Spec: Apply transparency to overlay

**Capability ID**: 190 | **Slug**: apply-overlay-transparency

## Overview

This capability provides apply transparency to overlay functionality for the RocketStats plugin. It integrates with the BakkesMod SDK and interacts with other subsystems through configuration variables, game events, or UI elements.

## Control Surfaces

- **Type**: `ui`
- **Evidence**: RocketStats.cpp:496 (rs_opacity affects all elements)
