# Implementation Spec: Switch theme based on menu state

**Capability ID**: 192 | **Slug**: auto-theme-switch-on-menu

## Overview

This capability hooks into Rocket League game events to detect switch theme based on menu state. The hook is registered during plugin initialization and fires whenever the corresponding event occurs.
...
- **Evidence**: RocketStats.cpp:434, OverlayManagement.cpp::InGameTheme
